...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    return {
      ...
      headers,
      body: JSON.stringify({
        ghl_api_key: settings.ghl_api_key ? settings.ghl_api_key.slice(0, 6) + '····' + settings.ghl_api_key.slice(-4) : null,
        ...
        resend_api_key: settings.resend_api_key ? settings.resend_api_key.slice(0, 6) + '····' + settings.resend_api_key.slice(-4) : null,
        webhook_url: settings.webhook_url,
        hasGhlKey: !!settings.ghl_api_key,
        hasResendKey: !!settings.resend_api_key,
        elevenlabsApiKey: settings.elevenlabs_api_key ? settings.elevenlabs_api_key.slice(0, 6) + '····' + settings.elevenlabs_api_key.slice(-4) : null,
        ...
        twilioAccountSid: settings.twilio_account_sid ? settings.twilio_account_sid.slice(0, 6) + '····' + settings.twilio_account_sid.slice(-4) : null,
        twilioAuthToken: settings.twilio_auth_token ? settings.twilio_auth_token.slice(0, 4) + '····' + settings.twilio_auth_token.slice(-4) : null,
