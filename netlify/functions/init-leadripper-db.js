...
exports.handler = async (event, context) => {
  ...
  try {
    console.log('Initializing LeadRipper database tables...');

    // Execute SQL
    await pool.query(SQL);

    console.log('✅ LeadRipper tables created successfully');
